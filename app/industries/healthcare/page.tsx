...
const agents = [
  { name: "EMILY", role: "Patient Services Agent", desc: "Schedules appointments, recommends doctors, and handles patient inquiries.", color: "#a78bfa", retellId: "agent_ddf03bcc20dc6fdd83adbc290c" },
  { name: "NICOLE", role: "Clinical Screening Agent", desc: "Performs symptom assessment and patient triage before consultation.", color: "#818cf8", retellId: "agent_670481e5581961108e2370f85c" },
];
  ...
  return (
    <div style={{ minHeight: "100vh", background: "#fff", fontFamily: "Inter, system-ui, sans-serif" }}>
      ...
      <section style={{ padding: "5rem 2rem", background: "#a78bfa", textAlign: "center" }}>
        ...
        <p style={{ color: "rgba(255,255,255,0.85)", fontSize: "1.125rem", marginBottom: "2rem" }}>Book a free demo and see EMILY in action.</p>
        <a href="https://cal.com/dhananjay-goel/30min"  rel="noopener noreferrer" style={{ background: "#fff", color: "#a78bfa", padding: "1rem 2.5rem", borderRadius: "8px", textDecoration: "none", fontWeight: 700, fontSize: "1rem", display: "inline-flex", alignItems: "center", gap: "0.5rem" }}>
