...
const features = [
  ...
  { icon: TrendingUp, title: "Cart Recovery", desc: "Proactively reach out to customers who abandoned carts and recover lost revenue automatically." },
  { icon: RefreshCw, title: "Automated Follow-ups", desc: "Schedule and execute follow-up calls at optimal intervals without manual intervention." },
  { icon: MessageSquare, title: "Personalized Scripts", desc: "Dynamic conversation flows adapt in real-time based on customer responses and history." },
  { icon: BarChart2, title: "Real-time Analytics", desc: "Track call outcomes, conversion rates, and campaign performance in a live dashboard." },
  { icon: Clock, title: "Timezone Aware", desc: "Calls are placed at the right time for each contact's timezone — no more angry early calls." },
];
...
const stats = [
  ...
  { v: "60%", l: "Lower cost per call" },
  { v: "10x", l: "Scale vs human teams" },
];
  ...
  return (
    <div style={{ minHeight: "100vh", background: "#fff", fontFamily: "Inter, system-ui, sans-serif" }}>
      ...
      <section style={{ padding: "5rem 2rem", background: "linear-gradient(135deg, #F0F4FF 0%, #fff 100%)", textAlign: "center" }}>
        <motion.div initial={{ opacity: 0, y: 24 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.5 }} style={{ maxWidth: "760px", margin: "0 auto" }}>
          <div style={{ display: "inline-flex", alignItems: "center", gap: "0.5rem", background: "#EEF2FF", padding: "0.4rem 1rem", borderRadius: "9999px", fontSize: "0.8rem", fontWeight: 700, color: "#4F46E5", textTransform: "uppercase", letterSpacing: "0.08em", marginBottom: "1.5rem" }}>
            <PhoneOutgoing size={14} /> Services
          </div>
          <h1 style={{ fontSize: "clamp(2.5rem, 5vw, 3.75rem)", fontWeight: 800, color: "#111827", letterSpacing: "-0.03em", lineHeight: 1.1, marginBottom: "1.5rem" }}>
            Outbound AI Voice Agents<br />
            <span style={{ color: "#4F46E5" }}>That Drive Revenue</span>
          </h1>
          <p style={{ fontSize: "1.125rem", color: "#6B7280", lineHeight: 1.7, marginBottom: "2.5rem", maxWidth: "600px", margin: "0 auto 2.5rem" }}>
            Scale your outbound calling operations 10x without adding headcount. AI agents handle cart recovery, follow-ups, reminders, and lead nurturing automatically.
          </p>
          <div style={{ display: "flex", gap: "1rem", justifyContent: "center", flexWrap: "wrap" }}>
            <a href="https://cal.com/dhananjay-goel/30min"  rel="noopener noreferrer" style={{ background: "#4F46E5", color: "#fff", padding: "0.875rem 2rem", borderRadius: "8px", textDecoration: "none", fontWeight: 700, fontSize: "1rem", display: "inline-flex", alignItems: "center", gap: "0.5rem" }}>
      ...
      <section style={{ padding: "5rem 2rem" }}>
        <div style={{ maxWidth: "1100px", margin: "0 auto" }}>
          <div style={{ textAlign: "center", marginBottom: "3rem" }}>
            ...
            <h2 style={{ fontSize: "clamp(1.75rem, 3vw, 2.5rem)", fontWeight: 800, color: "#111827", letterSpacing: "-0.025em" }}>Built to convert at scale</h2>
          </div>
      ...
      <section style={{ padding: "5rem 2rem", background: "#F9FAFB" }}>
        <div style={{ maxWidth: "1100px", margin: "0 auto", display: "grid", gridTemplateColumns: "1fr 1fr", gap: "4rem", alignItems: "center" }}>
          <motion.div initial={{ opacity: 0, x: -24 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true }}>
            ...
            <h2 style={{ fontSize: "clamp(1.75rem, 3vw, 2.25rem)", fontWeight: 800, color: "#111827", letterSpacing: "-0.025em", marginBottom: "1rem" }}>Every outbound scenario covered</h2>
            <p style={{ color: "#6B7280", lineHeight: 1.7, marginBottom: "2rem" }}>From cart recovery to payment reminders, our outbound agents execute high-volume calling campaigns with precision and personalization.</p>
            <a href="https://cal.com/dhananjay-goel/30min"  rel="noopener noreferrer" style={{ background: "#4F46E5", color: "#fff", padding: "0.875rem 2rem", borderRadius: "8px", textDecoration: "none", fontWeight: 700, fontSize: "0.9375rem", display: "inline-flex", alignItems: "center", gap: "0.5rem" }}>
      ...
      <section style={{ padding: "5rem 2rem", background: "#4F46E5", textAlign: "center" }}>
        <h2 style={{ fontSize: "clamp(1.75rem, 3vw, 2.5rem)", fontWeight: 800, color: "#fff", marginBottom: "1rem", letterSpacing: "-0.025em" }}>Start your outbound campaigns today</h2>
        <p style={{ color: "rgba(255,255,255,0.8)", fontSize: "1.125rem", marginBottom: "2rem" }}>See how AI outbound agents can 10x your revenue operations.</p>
        <a href="https://cal.com/dhananjay-goel/30min"  rel="noopener noreferrer" style={{ background: "#fff", color: "#4F46E5", padding: "1rem 2.5rem", borderRadius: "8px", textDecoration: "none", fontWeight: 700, fontSize: "1rem", display: "inline-flex", alignItems: "center", gap: "0.5rem" }}>
